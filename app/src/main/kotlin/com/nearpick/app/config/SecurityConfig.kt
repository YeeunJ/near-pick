        ...
        http
            ...
            .authorizeHttpRequests { auth ->
                auth
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/flash-purchases").hasRole("CONSUMER")
                    .requestMatchers(HttpMethod.GET, "/api/flash-purchases/me").hasRole("CONSUMER")
                    .requestMatchers(HttpMethod.GET, "/api/flash-purchases/{id}").hasRole("CONSUMER")
                    .requestMatchers(HttpMethod.PATCH, "/api/flash-purchases/{id}/cancel").hasRole("CONSUMER")
                    .requestMatchers(HttpMethod.GET, "/api/flash-purchases/merchant").hasRole("MERCHANT")
                    .requestMatchers(HttpMethod.PATCH, "/api/flash-purchases/pickup").hasRole("MERCHANT")
                    .requestMatchers(HttpMethod.PATCH, "/api/flash-purchases/{id}/cancel-by-merchant").hasRole("MERCHANT")
                    // 소상공인 전용
